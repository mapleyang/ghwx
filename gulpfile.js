...
gulp.task('build:style', function (){
    gulp.src('src/index.less', option)
        .pipe(less().on('error', function (e){
            console.error(e.message);
            this.emit('end');
        }))
...
gulp.task('build', ['build:assets', 'build:style', 'build:html']);

gulp.task('release', ['build:style', 'build']);

gulp.task('watch', ['release'], function () {
    gulp.watch('src/style/**/*', ['build:style']);
    gulp.watch('src/index.less', ['build:style']);
